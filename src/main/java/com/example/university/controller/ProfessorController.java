...
public class ProfessorController {
    ...
    @Autowired
    public class ProfessorJpaService professorJpaService;
    ...
    public Professor getProfessorById(@PathVariable("professorId") int professor){
    ...
    @DeleteMapping("/profesors/{professorId}")
