...
//import com.example.university.controller.ProfessorController.ProfessorJpaService;
...
public class StudentController {
    ...
    public Student updateStudent(@PathVariable("studentId" )int studentsId, @RequestBody Student student){
